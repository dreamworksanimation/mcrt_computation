...
ProgMcrtMergeComputation::onViewportChanged(const mcrt::BaseFrame &msg)
{
    ...
    // Also, mFeedbackActive is only updated by debug command and we don��t need to MTlock logic to access
...
ProgMcrtMergeComputation::processFeedback()
{
    ...
    // information here, but we technically don��t need these information under feedback logic.
